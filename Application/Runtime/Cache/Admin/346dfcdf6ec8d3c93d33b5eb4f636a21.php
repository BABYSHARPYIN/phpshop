        ...
        <form enctype="multipart/form-data" action="/index/Admin/Goods/add" method="post">
            ...
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        价格：￥<input type="text" name="promote_price" size="10" /> 开始时间：
                        <input type="text" id="promote_start_date" name="promote_start_date" /> 结束时间：
                        <input type="text" id="promote_end_date" name="promote_end_date" />
                    </td>
                </tr>
