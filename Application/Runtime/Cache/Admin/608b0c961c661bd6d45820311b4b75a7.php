        ...
        <form enctype="multipart/form-data" action="/index.php/Admin/Goods/edit/id/2.html" method="post">
            ...
            <table width="90%" class="tab_table" align="center">
                ...
                <tr>
                    ...
                    <td>
                        价格：￥<input type="text" name="promote_price" size="10" value="<?php echo $data['promote_price'] ?>" /> 开始时间：
                        <input type="text" id="promote_start_date" name="promote_start_date" value="<?php echo $data['promote_start_date'] ?>" /> 结束时间：
                        <input type="text" id="promote_end_date" name="promote_end_date" value="<?php echo $data['promote_end_date'] ?>" />
                    </td>
                </tr>
                ...
                <td>
                    <input type="text" name="sort_num" value="<?php echo $data['sort_num']; ?>" size="8" />更小的数值会被排序在前面
                </td>
                </tr>
            </table>
            <!-- 商品描述 -->
